...
# =================截图比对区域=================#
IMAGE_PATH = 'C:/Users/shliz/Desktop/Auto_GirlsFrontline/auto13_4/initial_IMG/'  # 读取截图的路径
...
CHANGE_FORCE_U_STEP8_CLICK_BOX = [0.47, 0.74, 0.52, 0.78]  # 选择Vector
...
RETIRE_CHARACTER_1_CLICK_BOX = [0.12, 0.3, 0.14, 0.36]  # 第一行的第一只人形
RETIRE_CHARACTER_2_CLICK_BOX = [0.24, 0.3, 0.26, 0.36]  # 第一行的第二只人形
RETIRE_CHARACTER_3_CLICK_BOX = [0.36, 0.3, 0.38, 0.36]  # 第一行的第三只人形
RETIRE_CHARACTER_4_CLICK_BOX = [0.48, 0.3, 0.50, 0.36]  # 第一行的第四只人形
RETIRE_CHARACTER_5_CLICK_BOX = [0.60, 0.3, 0.62, 0.36]  # 第一行的第五只人形
RETIRE_CHARACTER_6_CLICK_BOX = [0.72, 0.3, 0.74, 0.36]  # 第一行的第六只人形
...
def gotoRetire():
    ...
    for i in range(4):
        ...
        mouseClick(CHOOSE_FINISH_RETIRE_CLICK_BOX, 0.5, 1)
...
def backToMainMenu():
    ...
    mouseClick(NAVIGATE_MAIN_MENU_CLICK_BOX, 6, 7)
...
# 启动模拟器
def openSimulator():
    app_dir = r'D:\Program Files (x86)\mumu\emulator\nemu\EmulatorShell\NemuPlayer.exe'
    os.startfile(app_dir)  # 打开外部应用程序
    ...
    while True:
        ...
        #     backToMainMenu()
            ...
            if failCount >= 5:
                ...
                img.save("error_Record/" + str(combatCount) + ".png")
