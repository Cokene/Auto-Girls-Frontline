...
#=================截图比对区域=================#
IMAGE_PATH = 'C:/Users/shliz/Desktop/Auto_GirlsFrontline/auto4_6/initial_IMG/'#读取截图的路径   
...
DAILY_LOGIN_IMAGE_BOX = [0.37,0.32,0.52,0.40]#每日登录签到奖励判断区域   

#=================点击拖动区域=================#

#每日登录签到界面
LOGIN_STEP1_CLICK_BOX = [0.9,0.19,0.92,0.21]
LOGIN_STEP2_CLICK_BOX = [0.9,0.70,0.92,0.80]
LOGIN_STEP3_CLICK_BOX = [0.049,0.08,0.072,0.11]
...
MAP_DRAG_BOX = [0.80,0.70,0.90,0.8]
MAP_DRAG_VERT1_BOX = [0.80,0.7,0.90,0.8]
MAP_DRAG_VERT2_BOX = [0.80,0.2,0.90,0.25]

#队伍放置点
COMMAND_CLICK_BOX = [0.78,0.62,0.8,0.64]#指挥部
AIRPORT_CLICK_BOX = [0.81,0.25,0.83,0.27]#机场
...
#计划模式
PLAN_MODE_CLICK_BOX = [0.03,0.78,0.10,0.79]
PLAN_MODE_STEP1_CLICK_BOX = [0.64,0.61,0.66,0.63]
PLAN_MODE_STEP2_CLICK_BOX = [0.74,0.65,0.76,0.68]

#前往各点
POINT_1_CLICK_BOX = [0.80,0.38,0.81,0.40]
POINT_2_CLICK_BOX = [0.73,0.52,0.75,0.53]
POINT_3_CLICK_BOX = [0.64,0.61,0.66,0.63]
POINT_4_CLICK_BOX = [0.74,0.65,0.76,0.68]
...
#关闭游戏
CLOSE_GAME_CLICK_BOX = [0.53,0.02,0.54,0.04]
...
def combatPrepare(tiny = False):
    ...
    if tiny:
        ...
        mouseDrag(MAP_DRAG_VERT1_BOX,0,-1,2,500,0.001,1)  
    else:
        scaleMap(MAP_SCALE_BOX,1,6)
        mouseDrag(MAP_DRAG_VERT1_BOX,0,-1,2,500,0.001,1)  
...
def setTeam():
    ...
    if checkCount >= 40:
        return False
    time.sleep(0.2)
    mouseDrag(MAP_DRAG_VERT2_BOX,0,1,1,400,0.001,1)
    time.sleep(0.2)
...
#捡垃圾路径规划
def action_trace():
    print('ACTION: 捡垃圾路径规划')
    mouseClick(AIRPORT_CLICK_BOX,1,2)
    mouseClick(PLAN_MODE_CLICK_BOX,0.5,0.6)
    mouseClick(PLAN_MODE_STEP1_CLICK_BOX,0.5,0.6)
    mouseClick(PLAN_MODE_STEP2_CLICK_BOX,0.5,0.6)
...
def action_2():
    print("ACTION: 前往2号点")
    mouseClick(POINT_2_CLICK_BOX,3,4)
...
def restartCombat():
    ...
    checkCount = 0
    while not isMap() and checkCount < 100:
        time.sleep(0.2)
        checkCount += 1
    if checkCount >= 100:
        return False
